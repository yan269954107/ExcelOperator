...
public interface AppConstants {
    ...
    String[] SUB_UNIT_LIANJIEJIAN = {"丝扣连接", "活接", "管帽", "堵头", "空冷丝堵"};
    String[] SUB_UNIT_KAIKOUGUANXIAN = {"开口管线"};
    String[] SUB_UNIT_BENG = {"离线泵", "往复泵", "计量泵", "注入泵", "螺杆泵", "多级离线泵", "水环式真空泵"};
    ...
    String[] STR_EXTENSION_FULL = {"法兰 F","丝扣连接 S","活接 U","管帽 CAP","堵头 CP","开口管线 OEL",
    ...
    String[] E_HUANREQI = {"封头法兰", "管程进口法兰", "管程出口法兰", "管程进口阀", "管程出口阀", "管程出口导淋", "壳程进口法兰", "壳程出口法兰", "壳程进口阀", "壳程进口导淋", "壳程出口阀", "壳程出口副线", "壳程出口导淋", "出口温度表", "出料线热电偶", "预留口", "副线阀", "连接法兰", "堵头", "进出口跨线", "吹扫阀"};
    ...
    String[] EC_A = {"进口阀", "进口法兰", "出口阀", "出口导淋", "出口法兰", "空冷丝堵", "堵头"};
