...
public class Hand extends ParserTarget implements Serializable{
    ...
    public void setAi_juli(double ai_juli) {
        mai_juli = ai_juli;
    }

    public double get_Ai_juli() {
        return mai_juli;
    }
    ...
    public void setAp_gaodu(double ap_gaodu) {
        map_gaodu = ap_gaodu;
    }

    public double get_Ap_gaodu() {
        return map_gaodu;
    }
    ...
    public void setAu_chicun(int au_chicun) {
        mau_chicun = au_chicun;
    }

    public int get_Au_chicun() {
        return mau_chicun;
    }
    ...
    public void setAw_chanpinliu(int aw_chanpinliu) {
        maw_chanpinliu = aw_chanpinliu;
    }

    public int get_Aw_chanpinliu() {
