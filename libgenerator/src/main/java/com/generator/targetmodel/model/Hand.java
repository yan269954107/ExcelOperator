...
public class Hand extends ParserTarget {
    ...
    private String mao_louceng;
    private String map_gaodu;
    ...
    private String mau_chicun;
    private String mav_jiezhizhuangtai;
    private String maw_chanpinliu;
    ...
    public String get_Aa_weizhi1() {
        return maa_weizhi1;
    }

    public void setAb_weizhi2(String ab_weizhi2) {
        mab_weizhi2 = ab_weizhi2;
    }

    public String get_Ab_weizhi2() {
        return mab_weizhi2;
    }

    public void setAc_weizhi3(String ac_weizhi3) {
        mac_weizhi3 = ac_weizhi3;
    }

    public String get_Ac_weizhi3() {
        return mac_weizhi3;
    }

    public void setAd_biaoqian(String ad_biaoqian) {
        mad_biaoqian = ad_biaoqian;
    }

    public String get_Ad_biaoqian() {
        return mad_biaoqian;
    }

    public void setAe_kuozhanhao(String ae_kuozhanhao) {
        mae_kuozhanhao = ae_kuozhanhao;
    }

    public String get_Ae_kuozhanhao() {
        return mae_kuozhanhao;
    }

    public void setAf_tuhao(String af_tuhao) {
        maf_tuhao = af_tuhao;
    }

    public String get_Af_tuhao() {
        return maf_tuhao;
    }

    public void setAg_zhuyaocankaowu(String ag_zhuyaocankaowu) {
        mag_zhuyaocankaowu = ag_zhuyaocankaowu;
    }

    public String get_Ag_zhuyaocankaowu() {
        return mag_zhuyaocankaowu;
    }

    public void setAh_fangxiang(String ah_fangxiang) {
        mah_fangxiang = ah_fangxiang;
    }

    public String get_Ah_fangxiang() {
        return mah_fangxiang;
    }

    public void setAi_juli(String ai_juli) {
        mai_juli = ai_juli;
    }

    public String get_Ai_juli() {
        return mai_juli;
    }

    public void setAj_danwei(String aj_danwei) {
        maj_danwei = aj_danwei;
    }

    public String get_Aj_danwei() {
        return maj_danwei;
    }

    public void setAk_ciyaocankaowu(String ak_ciyaocankaowu) {
        mak_ciyaocankaowu = ak_ciyaocankaowu;
    }

    public String get_Ak_ciyaocankaowu() {
        return mak_ciyaocankaowu;
    }

    public void setAl_fangxiang(String al_fangxiang) {
        mal_fangxiang = al_fangxiang;
    }

    public String get_Al_fangxiang() {
        return mal_fangxiang;
    }

    public void setAm_juli(String am_juli) {
        mam_juli = am_juli;
    }

    public String get_Am_juli() {
        return mam_juli;
    }

    public void setAn_danwei(String an_danwei) {
        man_danwei = an_danwei;
    }

    public String get_An_danwei() {
        return man_danwei;
    }

    public void setAo_louceng(String ao_louceng) {
        mao_louceng = ao_louceng;
    }

    public String get_Ao_louceng() {
        return mao_louceng;
    }

    public void setAp_gaodu(String ap_gaodu) {
        map_gaodu = ap_gaodu;
    }

    public String get_Ap_gaodu() {
        return map_gaodu;
    }

    public void setAq_danwei(String aq_danwei) {
        maq_danwei = aq_danwei;
    }

    public String get_Aq_danwei() {
        return maq_danwei;
    }

    public void setAr_fujiamiaoshu(String ar_fujiamiaoshu) {
        mar_fujiamiaoshu = ar_fujiamiaoshu;
    }

    public String get_Ar_fujiamiaoshu() {
        return mar_fujiamiaoshu;
    }

    public void setAs_zujianleixing(String as_zujianleixing) {
        mas_zujianleixing = as_zujianleixing;
    }

    public String get_As_zujianleixing() {
        return mas_zujianleixing;
    }

    public void setAt_zujianzileixing(String at_zujianzileixing) {
        mat_zujianzileixing = at_zujianzileixing;
    }

    public String get_At_zujianzileixing() {
        return mat_zujianzileixing;
    }

    public void setAu_chicun(String au_chicun) {
        mau_chicun = au_chicun;
    }

    public String get_Au_chicun() {
        return mau_chicun;
    }

    public void setAv_jiezhizhuangtai(String av_jiezhizhuangtai) {
        mav_jiezhizhuangtai = av_jiezhizhuangtai;
    }

    public String get_Av_jiezhizhuangtai() {
        return mav_jiezhizhuangtai;
    }

    public void setAw_chanpinliu(String aw_chanpinliu) {
        maw_chanpinliu = aw_chanpinliu;
    }

    public String get_Aw_chanpinliu() {
        return maw_chanpinliu;
    }

    public void setAx_jiancepeijian(String ax_jiancepeijian) {
        max_jiancepeijian = ax_jiancepeijian;
    }

    public String get_Ax_jiancepeijian() {
        return max_jiancepeijian;
    }

    public void setAy_shengchanchangjia(String ay_shengchanchangjia) {
        may_shengchanchangjia = ay_shengchanchangjia;
    }

    public String get_Ay_shengchanchangjia() {
        return may_shengchanchangjia;
    }

    public void setAz_lujinghao(String az_lujinghao) {
        maz_lujinghao = az_lujinghao;
    }

    public String get_Az_lujinghao() {
        return maz_lujinghao;
    }

    public void setBa_biangengguanliID(String ba_biangengguanliID) {
        mba_biangengguanliID = ba_biangengguanliID;
    }

    public String get_Ba_biangengguanliID() {
        return mba_biangengguanliID;
    }

    public void setBb_nianyunxingshijian(String bb_nianyunxingshijian) {
        mbb_nianyunxingshijian = bb_nianyunxingshijian;
    }

    public String get_Bb_nianyunxingshijian() {
        return mbb_nianyunxingshijian;
    }

    public void setBc_tianjiariqi(String bc_tianjiariqi) {
        mbc_tianjiariqi = bc_tianjiariqi;
    }

    public String get_Bc_tianjiariqi() {
